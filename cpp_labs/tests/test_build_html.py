"""Tests for cpp_labs.build_html (RED phase — all will fail until implemented)."""
...
from cpp_labs.build_html import build_lab, capture_variant, expand_variants
from cpp_labs.code_generator import CaseDef, ControlDef, TopicTemplate, generate_source
